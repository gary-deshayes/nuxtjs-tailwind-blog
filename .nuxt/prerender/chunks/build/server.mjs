...
import { $fetch } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/ofetch/dist/node.mjs';
...
import { getContext } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/defu/dist/defu.mjs';
import { withQuery, hasProtocol, isScriptProtocol, joinURL } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C9nssdus.mjs').then((m) => m.default || m)
  }
];
...
const LazySvgoAcademy = defineAsyncComponent(() => import('./academy-CwAh-eDR.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoArrow = defineAsyncComponent(() => import('./arrow-DzQRZ4pY.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoBriefcase = defineAsyncComponent(() => import('./briefcase-CSGayJBZ.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoCalendar = defineAsyncComponent(() => import('./calendar-Be0Cx6K3.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoExternal = defineAsyncComponent(() => import('./external-BQHhpPnq.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoFacebook = defineAsyncComponent(() => import('./facebook-d32OmsK8.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoFolder = defineAsyncComponent(() => import('./folder-CGvUsXzI.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoGithub = defineAsyncComponent(() => import('./github-BXRDu3H9.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoGithubNew = defineAsyncComponent(() => import('./github_new-yJg5xu7a.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoGlob = defineAsyncComponent(() => import('./glob-BC-uenCk.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoHome = defineAsyncComponent(() => import('./home-Bfm7bblu.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoLinkeding = defineAsyncComponent(() => import('./linkeding-f4y5n5DI.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoMail = defineAsyncComponent(() => import('./mail-BbpqTkXc.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-DZtWIFra.mjs').then((m) => m.default || m)
};
