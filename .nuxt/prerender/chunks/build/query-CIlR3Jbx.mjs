import { a as useRuntimeConfig, g as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Cduq26lA.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CIlR3Jbx.mjs.map
