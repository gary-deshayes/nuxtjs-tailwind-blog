import { _ as __nuxt_component_0 } from './nuxt-img-Brvmn0wC.mjs';
import { mergeProps, useSSRContext, unref, withAsyncContext, createVNode, resolveDynamicComponent, openBlock, createElementBlock, createElementVNode } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderVNode } from 'file://C:/Users/Gary/Documents/Projets/nuxtjs-tailwind-blog/node_modules/vue/server-renderer/index.mjs';
import { s as siteMetaInfo, a as author } from './sitemetainfo-Cf_GwHko.mjs';
import { u as useAsyncData } from './asyncData-BrpQo2jV.mjs';
import { q as queryContent } from './query-CIlR3Jbx.mjs';
import { a as useSeoMeta } from './index-DIUDACRG.mjs';
import './server.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "md:fixed"
      }, _attrs))}><div class="md:block flex justify-center items-center">`);
      _push(ssrRenderComponent(_component_nuxt_img, {
        src: unref(author).author_image,
        loading: "lazy",
        alt: "me",
        class: "shadow-xl sm:h-60 sm:w-60 h-32 w-32 rounded-full"
      }, null, _parent));
      _push(`<div class="mb-2 md:mx-7 mt-4 mx-4 justify-center items-center"><h1 class="md:text-3xl text-lg text-gray-800 font-bold dark:text-blue-100">${ssrInterpolate(unref(author).name)}</h1><div class="md:text-lg text-sm text-gray-600 dark:text-blue-100">${ssrInterpolate(unref(author).position)}</div><a${ssrRenderAttr("href", `mailto:${unref(author).email}`)} class="text-gray-600 text-sm md:hidden mt-1 dark:text-blue-100">${ssrInterpolate(unref(author).email)}</a></div></div><div class="mx-7 hidden md:block"><div class="my-2 text-gray-600 flex dark:text-blue-100">`);
      _push(ssrRenderComponent(unref(Mail), null, null, _parent));
      _push(`<a class="ml-2"${ssrRenderAttr("href", `mailto:${unref(author).email}`)}>${ssrInterpolate(unref(author).email)}</a></div><div class="my-2 text-gray-600 flex dark:text-blue-100">`);
      _push(ssrRenderComponent(unref(Glob), null, null, _parent));
      _push(`<p class="ml-2">${ssrInterpolate(unref(author).location)}</p></div><div class="my-2 text-gray-600 flex dark:text-blue-200">`);
      _push(ssrRenderComponent(unref(Github), null, null, _parent));
      _push(`<a class="ml-2"${ssrRenderAttr("href", `https://github.com/${unref(author).github}`)}>${ssrInterpolate(unref(author).github)}</a></div></div></div>`);
    };
  }
};
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    const {
      data: intro
    } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("intro", () => queryContent("/author").where({
      page: "intro"
    }).findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "mb-6"
      }, _attrs))}><h2 class="mt-6 text-4xl text-gray-700 font-bold capitalize dark:text-blue-200">${ssrInterpolate(unref(intro).title)}</h2><div><p class="py-2"> En tant que d\xE9veloppeur je rencontre souvent des probl\xE8mes, plut\xF4t que de me r\xE9jouir et de passer \xE0 autre chose je vous mets \xE0 disposition les solutions \xE0 travers des <b class="text-blue-500">tutoriels de d\xE9veloppement web</b> qui je l\u2019esp\xE8re vous \xE9vitera de perdre autant de temps que moi. </p><p class="py-2"> Je m\u2019appelle <b class="text-blue-500">Gary DESHAYES</b> et je suis <b class="text-blue-500">d\xE9veloppeur web dans l\u2019Oise</b> depuis maintenant plus de 6 ans. </p><p class="py-2"> Je suis <b class="text-blue-500">d\xE9veloppeur web Full Stack</b> et je r\xE9alise mes sites web via <b class="text-blue-500">Vue.js</b> et <b class="text-blue-500">Symfony/Node.js</b> principalement mais j\u2019apprends souvent de nouvelles technologies pour ne pas perdre la main sur toutes ces \xE9volutions. </p><p class="py-2"> Je suis \xE9galement disponible pour vos projets en tant que <a href="https://www.malt.fr/profile/garydeshayes"><b class="text-blue-500 underline">D\xE9veloppeur web Fullstack freelance sur Malt</b></a>, contactez moi via le bouton ci-dessous ! </p></div></div>`);
    };
  }
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(Object.keys(unref(expertises)), (key) => {
        ...
        ssrRenderList(unref(expertises)[key], (expertise) => {
          _push(`<li class="flex items-center"${ssrRenderAttr("title", expertise.description)}>`);
          ssrRenderVNode(_push, createVNode(resolveDynamicComponent(expertise.icon), {
            class: "h-14 w-14"
          }, null), _parent);
          _push(`</li>`);
        });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "opacity-100 mt-10"
      }, _attrs))}><ol class="relative border-l border-gray-200 dark:border-gray-700"><!--[-->`);
      ssrRenderList(unref(timeline), (time) => {
        ...
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(time.icon), {
        ...
        if (time.currently) {
          _push(`<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3"> Maintenant </span>`);
        } else {
          _push(`<!---->`);
        }
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-w-screen-lg md:flex mx-auto dark:bg-gray-900"><div class="md:w-1/3 p-2 md:flex md:justify-center">`);
...
//# sourceMappingURL=index-C9nssdus.mjs.map
