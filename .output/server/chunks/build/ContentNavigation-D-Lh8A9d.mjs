...
import { k as useState, c as useRuntimeConfig } from './server.mjs';
import { C as hash } from '../runtime.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DUprJH0g.mjs';
import { u as useContentPreview } from './preview-B-M8xQ4k.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BYJ28KZb.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-D-Lh8A9d.mjs.map
