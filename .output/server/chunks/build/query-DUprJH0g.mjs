import { c as useRuntimeConfig, d as useRequestEvent } from './server.mjs';
import { x as withLeadingSlash, n as joinURL, A as withoutTrailingSlash, B as withBase, C as hash } from '../runtime.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BYJ28KZb.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DUprJH0g.mjs.map
