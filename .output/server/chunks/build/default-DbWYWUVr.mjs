...
import { defineComponent, h, provide, shallowReactive, ref, inject, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withAsyncContext, unref, withCtx, createTextVNode, toDisplayString, computed, openBlock, createElementBlock, createElementVNode } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { P as PageRouteSymbol, e as useNuxtApp, L as LayoutMetaSymbol, l as generateRouteKey$1, m as appPageTransition, o as appKeepalive, p as _wrapIf, w as wrapInKeepAlive, t as toArray, _ as _export_sfc } from './server.mjs';
import { RouterView } from 'vue-router';
import { r as defu } from '../runtime.mjs';
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    const { data: pages } = ([__temp, __restore] = withAsyncContext(() => useFetch("https://gary-deshayes.com/wp-json/wp/v2/pages", "$9tf6HNKnbq")), __temp = await __temp, __restore(), __temp);
    console.log(pages);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "flex justify-center border-blue-200 md:bg-blue-500 dark:bg-blue-800 dark:border-blue-700 bg-white" }, _attrs))}><div class="max-w-screen-xl flex flex-wrap items-center justify-center"><div class="flex justify-center md:hidden lg:hidden"><a href="#" class="flex items-center space-x-3 rtl:space-x-reverse"><img${ssrRenderAttr("src", _imports_0)} class="h-12" alt="Gary DESHAYES"></a></div><button data-collapse-toggle="navbar-solid-bg" type="button" class="inline-flex items-center justify-end p-2 w-10 h-10 justify-center text-sm text-blue-500 rounded-lg md:hidden focus:ring-gray-200 focus:text-black" aria-controls="navbar-solid-bg" aria-expanded="false"><span class="sr-only">Open main menu</span><svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"></path></svg></button><div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg"><ul class="flex flex-col font-medium mt-4 sm:rounded-lg bg-blue-500 md:space-x-2 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700"><li><button id="dropdownNavbarLink-page" data-dropdown-toggle="dropdownNavbar-page" class="flex items-center justify-between block px-4 py-3 no-underline text-white hover:text-black font-bold text-lg md:text-sm cursor-pointer">Dossiers <svg class="w-4 h-4 ms-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"></path></svg></button><div id="dropdownNavbar-page" class="z-10 hidden font-normal bg-blue-700 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"><ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton"><!--[-->`);
      ssrRenderList(unref(pages), (page) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, { class: "block md:inline-block pl-3 my-2 no-underline text-white hover:text-grey-darker font-bold text-lg md:text-sm cursor-pointer hover:text-black" }, null, _parent));
        _push(`</li>`);
      });
      _push(`<!--]--></ul></div></li><!--[-->`);
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [
                  createTextVNode(toDisplayString(parent.item.name), 1)
                ];
              }
            }),
            _: 2
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "w-fullpb-12 antialiased bg-white" }, _attrs))}><div class="max-w-8xl"><div class="flex justify-center hidden md:flex"><a href="/" class="flex items-center space-x-3 rtl:space-x-reverse"><img${ssrRenderAttr("src", _imports_0)} class="h-12" alt="Flowbite Logo"></a></div>`);
...
//# sourceMappingURL=default-DbWYWUVr.mjs.map
