...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const {
      data: article
    } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("home", () => queryContent("/articles").where({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "px-4 mx-auto sm:px-6 xl:max-w-5xl xl:px-0 mt-10"
      }, _attrs))}><p class="text-center font-bold my-5 text-indigo-500">${ssrInterpolate(formatDate((_a22 = unref(article)) == null ? void 0 : _a22.date))}</p><h1 class="text-4xl text-gray-700 font-extrabold mb-10 text-center">${ssrInterpolate((_b2 = unref(article)) == null ? void 0 : _b2.title)}</h1><div class="flex items-center font-medium mt-6 sm:mx-3 justify-center">`);
      ...
      _push(ssrRenderComponent(_component_ContentRenderer, {
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("p", null, "No content found.")];
          }
        }),
        _: 1
      }, _parent));
...
//# sourceMappingURL=_slug_-xrhU8EsG.mjs.map
