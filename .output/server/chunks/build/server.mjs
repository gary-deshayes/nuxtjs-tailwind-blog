...
const _routes = [
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-UJ8Aei0O.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-categorie-slug",
    path: "/blog/categorie/:slug()",
    component: () => import('./_slug_-C8sJtpXr.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-C1YmmRNy.mjs').then((m) => m.default || m)
  },
  {
    name: "content-slug",
    path: "/content/:slug(.*)*",
  ...
  },
  {
    ...
    component: () => import('./_town_-Iujogc07.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DKor3z_m.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-CtK2_R9z.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-DbWYWUVr.mjs').then((m) => m.default || m)
};
