import { _ as _sfc_main$1 } from './blogItem-wn7FHvw0.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const {
      data: posts
    } = ([__temp, __restore] = withAsyncContext(() => useFetch("https://gary-deshayes.com/wp-json/wp/v2/posts?_embed", {
      query: {
        page: 10
      }
    }, "$ansXcfZp0C")), __temp = await __temp, __restore(), __temp);
    [__temp, __restore] = withAsyncContext(() => useAsyncData("home", () => queryContent("/articles").only(["title", "description", "image", "img", "slug", "tags", "author", "date", "draft"]).sort({
      date: 1
    }).find())), __temp = await __temp, __restore();
    useSeoMeta({
...
//# sourceMappingURL=index-BiXkuync.mjs.map
